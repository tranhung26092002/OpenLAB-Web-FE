        ...
        <Fragment>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.intro_detail}>
                    ...
                    <p>OpenLAB đã và đang xây dựng, triển khai những sản phẩm thiết thực nhằm tối ưu các quy trình/nghiệp vụ trong các trường Đại học từ khâu tuyển sinh, đào tạo đến xét duyệt tốt nghiệp và quản lý văn bằng chứng chỉ dựa trên công nghệ Blockchain.</p>
                </div>

                <div className={styles.field_active}>
                    <h2>Lĩnh vực hoạt động</h2>
                    <p>OpenLAB cung cấp các nền tảng Đại học số nhằm đáp ứng mục tiêu cá nhân hoá quá trình đào tạo, đào tạo mọi lúc mọi nơi, đào tạo đồng thời quy mô lớn, phục vụ đa dạng nhu cầu đào tạo (đào tạo lại, đào tạo nâng cao, đào tạo suốt đời…)</p>
                    <ol>
                    ...
                    <div className={styles.reasons_right}>
                        ...
                        <div className={styles.reason1}>
                            ...
                            <div className={styles.text_reason_right}>
                                ...
                                <p>OpenLAB luôn hướng tới việc đem lại những trải nghiệm tốt nhất cho khách hàng, tiếp thu mọi ý kiến đóng góp để cải thiện chất lượng sản phẩm.</p>
                            </div>
                        </div>
                        <div className={styles.reason2}>
                            ...
                            <div className={styles.text_reason_right}>
                                ...
                                <p>OpenLAB luôn tiên phong trong việc ứng dụng những tiến bộ Khoa học vào việc phát triển ứng dụng, nhu cầu thị trường hướng tới hiệu quả người dùng.</p>
                            </div>
                        </div>
                        <div className={styles.reason3}>
                            ...
                            <div className={styles.text_reason_right}>
                                ...
                                <p>Đội ngũ OpenLAB luôn khắt khe trong từng chi tiết nhỏ và lấy người dùng làm trung tâm.</p>
                            </div>
                        </div>
                    </div>
                </div>
