  ...
  return (
    <MainLayout>
      <div className="pb-24 xs:py-0">
        ...
        <div className="px-24 lg:px-16 sm:px-14 pt-24 flex gap-7 xs:px-5 xs:py-14 xs:flex-col sm:flex-col">
          <div className="w-2/3 lg:w-[55%] flex justify-end items-start gap-5 flex-wrap sm:flex-col xs:flex-col xs:w-full sm:w-full  lg:flex-col">
            {dataBlog.map((item, index) => {
              return (
                <div
                  key={index}
                  className="shadow-xl w-[40%] px-6 py-6 rounded-md h-[520px] sm:w-full xs:w-full lg:w-full lg:text-lg"
                >
          ...
          <div className=" flex flex-col gap-8 w-[31%] lg:w-[45%] justify-start items-start sm:w-full xs:w-full">
