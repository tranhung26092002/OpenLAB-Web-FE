...
export default function Lesson1({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="px-16 flex flex-col justify-center items-center w-full ">
      <Link
        href={`/products/courses/${slug}/lesson3`}
        className="px-4 py-2 bg-blue-500 w-full rounded-sm mt-4 text-center text-white"
      >
        Quay lại
      </Link>
      <TitleLesson
      ...
      {/* <Link href={`/products/courses/${slug}/lesson2`}>Continue</Link> */}
    </div>
  );
}
