...
const SectionSolution = () => {
  return (
    <div className="body-section-solution py-16 px-28 bg-[#f4f7fc] sm:px-16 lg:px-20 xs:px-4 xs:py-10 xl:px-20">
      <div className="content-section-solution  sm:flex-col xs:flex-col text-center flex justify-between gap-8 sm:gap-16 items-center">
        ...
        >
          ...
          <p className="mt-2 font-normal text-base mb-8 sm:text-lg ">
        ...
        >
          ...
          <div className="cover-image-left flex-col gap-7 mt-14 sm:mt-0 hidden xl:flex 2xl:flex sm:flex">
            <Image
          ...
          <div className="cover-image-right  flex flex-col gap-7">
            <Image
              className="object-contain w-[230px]  xs:w-[280px] shadow-2xl hover:scale-105 cursor-pointer h-[230px] border-[#8AD9E4] border-2 rounded object-center px-3 py-3 bg-white xs:h-60"
              src={imageSolution3}
              alt={""}
            />
            <Image
              className="object-contatin hover:scale-105 xs:w-[280px] cursor-pointer shadow-2xl w-[230px] h-[230px] border-[#8AD9E4] border-2 rounded object-center bg-white xs:h-60"
              src={imageSolution4}
              alt={""}
            />
          </div>
