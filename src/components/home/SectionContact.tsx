...
const SectionContact = () => {
  return (
    <div className="body-section-contact flex justify-around items-start px-20 py-20  sm:px-14 xs:py-10">
      <div className="content-section-contact flex justify-center items-center gap-6 xs:flex-col">
        ...
        <div className="px-10 sm:pr-0 w-1/2 sm:w-2/3 flex flex-col gap-4 items-start justify-center xs:w-full">
