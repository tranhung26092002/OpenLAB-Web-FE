...
const SectionServices = () => {
  ...
  return (
    <div className="body-service py-16  px-16 xs:px-5 sm:px-5 xs:py-14">
            ...
            {dataServices.map((item, index) => {
              ...
              return (
                <div className="my-5 mx-2" key={index}>
                  <div
                    className=" flex flex-col relative justify-start gap-4 sm:w-[95%] w-[92%] items-center rounded-xl px-3
