      ...
      <div className=" flex justify-center flex-col items-center bg-banner_homepage h-[560px] xs:h-[450px] sm:h-[490px]  sm:w-full xs:w-full bg-cover  bg-no-repeat bg-center ">
        <div className="flex flex-col justify-center">
          <div className="flex flex-col gap-3">
            ...
            <span
              data-aos="fade-right"
              className="text-4xl font-semibold text-center text-white mt-2 sm:text-3xl xs:text-2xl"
            >
          ...
          <p
            data-aos="fade-left"
            data-aos-delay="400"
            className="text-lg font-semibold text-center text-white mt-8 mb-10 xs:text-base"
          >
