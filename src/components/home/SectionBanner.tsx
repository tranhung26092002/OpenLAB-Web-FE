...
const SectionBanner = () => {
  return (
    <div className="body flex justify-center flex-col items-center w-full bg-gradient-to-r from-[#090979] from-0% via-[#054c5c] via-[41%]  to-[#090979] to-100% ">
      <div className=" flex justify-center flex-col items-center bg-banner_homepage h-[560px] xs:h-[450px] sm:h-[490px]  sm:w-full xs:w-full bg-cover  bg-no-repeat bg-center ">
        <div className="flex flex-col justify-center ">
          <div className="flex flex-col gap-3 xs:gap-0 ">
            ...
            <span
              data-aos="fade-right"
              className="text-4xl font-semibold text-center text-white mt-2 sm:text-3xl xs:text-2xl  xs:mt-0 xs:px-10"
            >
          ...
          <p
            data-aos="fade-left"
            data-aos-delay="400"
            className="text-lg font-semibold text-center text-white mt-8 mb-10 xs:text-sm xs:px-10 "
          >
