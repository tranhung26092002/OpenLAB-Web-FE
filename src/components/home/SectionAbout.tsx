...
const SectionAbout = () => {
  return (
    <div className="body-section-about px-16 py-16 bg-[#f4f7fc] sm:px-16 xs:px-4 xs:py-14">
      <div className="content-section-about flex justify-between items-center gap-14 sm:flex-col-reverse xs:flex-col-reverse">
        ...
        <div
          ...
          data-aos="fade-left"
        >
          <span className="text-4xl font-semibold xs:text-2xl xs:text-center lg:text-[25px] w-full">
