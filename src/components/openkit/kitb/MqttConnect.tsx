        ...
        mqttClient.on("message", (_topic, message) => {
          try {
            ...
            const temperatureValue = data.temperature
              ? data.temperature.toFixed(2).toString()
              : "N/A";
            const humidityValue = data.humidity
              ? data.humidity.toFixed(2).toString()
              : "N/A";
            const gasValue = data.gas ? data.gas.toFixed(2).toString() : "N/A";
            const lightValue = data.light
              ? data.light.toFixed(2).toString()
              : "N/A";
