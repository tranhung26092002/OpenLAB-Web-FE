            ...
            {data.map((item, index) => {
              return (
                <div className="my-3 " key={index}>
                  <div className=" px-7 py-10 sm:py-4 xs:py-4 xs:px-3 w-[95%] mx-1 shadow-lg rounded-md h-72 xl:h-[310px] sm:h-[350px] xs:h-56 sm:px-3 flex justify-around flex-col xs:justify-start ">
                    <div className="flex justify-between items-center">
                      <LuQuote className="text-3xl text-red-300 mb-5 xs:text-xl lg:text-2xl" />
                      {item.bgImg ? (
                    ...
                    <p className="text-justify pr-3 xs:pr-0 sm:pr-0 mb-2 xs:text-sm xs:text-justify">
                      {item.feedback}
                    </p>
